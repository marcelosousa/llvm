/* include/hs_llvm_config.h.  Generated from hs_llvm_config.h.in by configure.  */
...
#define HS_LLVM_VERSION 304

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "bos@serpentine.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Haskell LLVM FFI bindings"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Haskell LLVM FFI bindings 3.0.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "llvm-base"
